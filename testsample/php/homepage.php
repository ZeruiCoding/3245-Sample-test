        ...
        <section class="feedback-section" id="feedbackSection">
            <div class="feedback-wrapper">
                <div class="feedback-form-container">
                    ...
                    <form action="#" method="POST" onsubmit="alert('Thank you! We will get back to you soon.'); return false;">
                        <input type="text" class="pill-input" placeholder="Full Name" required>
                        <input type="email" class="pill-input" placeholder="Email address" required>
                        <input type="tel" class="pill-input" placeholder="Phone number">
                        <textarea class="pill-input" placeholder="Your message or suggestions..." required></textarea>
                        <button type="submit" class="send-btn">SEND MESSAGE <svg viewBox="0 0 24 24"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></button>
                    </form>
                </div>
                <div class="contact-info-container">
                    <h3 class="contact-header">Contact Info</h3>
                    <div class="info-item"><img src="../IMG/phone.png" alt="Location" class="info-icon"><span class="info-text">Knowledge Temple, Book Street<br>Hong Kong</span></div>
                    ...
                    <div class="social-links"><div class="social-circle">Ins</div><div class="social-circle">X</div><div class="social-circle">Yt</div><div class="social-circle">In</div></div>
                </div>
            </div>
        </section>
