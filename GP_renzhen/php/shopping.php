...
if (isset($_GET['q']) && !empty($_GET['q'])) {
    ...
    foreach ($categories_structure as $p => $subs) {
        if (in_array($cat, $subs)) { $current_main = $p; break; }
    }
}
...
if (isset($_GET['type']) && $_GET['type'] == 'hot') {
    $order_by = "ORDER BY sales_count DESC"; // hot book sort sales count
} elseif (isset($_GET['type']) && $_GET['type'] == 'new') {
    $order_by = "ORDER BY publish_date DESC"; // new book sort date
}
...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if (!empty($row['manual_tag']) && $row['manual_tag'] != 'NULL') {
            // Manual tag
            if ($row['manual_tag'] == 'NEW') $tag = "NEW";
            elseif ($row['manual_tag'] == 'HOT') $tag = "HOT";
        } else {
            // auto
    ...
    <div class="container">
        ...
        <div class="shop-layout">
            ...
            <main class="product-area">
                ...
                <div class="book-grid">
                    <?php if (count($books_to_display) > 0) { 
                        foreach($books_to_display as $row) {
                    ...
                    <div class="book-card" onclick="openModal(this)" 
                        ...
                        <?php if ($display_tag == 'NEW'): ?>
                            <div class="tag tag-new">NEW</div>
                        <?php elseif ($display_tag == 'HOT'): ?>
        ...
        <div class="footer-container">
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="homepage.php#aboutUsSection">About Us</a></li>
                    <li><a href="homepage.php#feedbackSection">Contact Us</a></li>
